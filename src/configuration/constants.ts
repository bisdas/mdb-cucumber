...
export const CUCUMBER_SHARE_IDEA_EMAIL_SUBJECT = 'Cucumber (Delish Bowl) - Sharing a Product Idea'
export const CUCUMBER_REPORT_ERROR_EMAIL_SUBJECT = 'Cucumber (Delish Bowl) - Reporting an Error'
